        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="t" data-aos="fade-right" data-aos-duration="800">
                    ...
                    <p>Наши менеджеры предоставят БЕСПЛАТНУЮ консультацию и помогут с выбором</p>
                </div>
            </div>
            <div class="col-md-12">
                <div class="team-slider">
                    ...
                    <div>
                        <div class="part-card" data-aos="flip-down" data-aos-duration="1000">
                            <div class="part-img gradient-box" style="background-image: url('<?= get_template_directory_uri(); ?>/images/team/oksana.png')">
                                <div class="gradient-box-style"><div></div></div>
                                <div class="gradient-box-style gradient-box-style-rotate"><div></div></div>

                            </div>
                            <h5>Борисовская Оксана<br> <span>Директор компании<br>  Golden Elephant</span> </h5>
                            <hr>
                    ...
                    <div>
                        <div class="part-card" data-aos="flip-down" data-aos-duration="1000">
                            <div class="part-img gradient-box" style="background-image: url('<?= get_template_directory_uri(); ?>/images/team/maks.jpg')">
                                <div class="gradient-box-style"><div></div></div>
                                <div class="gradient-box-style gradient-box-style-rotate"><div></div></div>

                            </div>
                            <h5>Пихур Максим<br> <span>Директор компании<br>  Golden Elephant</span></h5>
                            <hr>
                    ...
                    <div>
                        <div class="part-card" data-aos="flip-down" data-aos-duration="1000">
                            <div class="part-img gradient-box" style="background-image: url('<?= get_template_directory_uri(); ?>/images/team/natasha.jpg')">
                                <div class="gradient-box-style"><div></div></div>
                                <div class="gradient-box-style gradient-box-style-rotate"><div></div></div>

                            </div>
                            <h5>Наталья Мельник<br><span>Персональный<br>  брокер</span></h5>
                            <hr>
                    ...
                    <div>
                        <div class="part-card" data-aos="flip-down" data-aos-duration="1000">
                            <div class="part-img gradient-box" style="background-image: url('<?= get_template_directory_uri(); ?>/images/team/yana.jpg')">
                                <div class="gradient-box-style"><div></div></div>
                                <div class="gradient-box-style gradient-box-style-rotate"><div></div></div>

                            </div>
                            <h5>Вирзум Яна<br><span>Персональный<br>  брокер</span></h5>
                            <hr>
                    ...
                    <div>
                        <div class="part-card" data-aos="flip-down" data-aos-duration="1000">
                            ...
                            <h5>Иван Борисовский<br> <span>Менеджер  послепродажного<br>  обслуживания</span></h5>
                            <hr>
